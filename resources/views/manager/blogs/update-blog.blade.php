...
@section('content')
    <div class="container p-2 ">
        ...
        <form class="form-control shadow" action="{{ route('blog.update', $blog->id) }}" method="POST"
              enctype="multipart/form-data">
            <div class=" p-3 mb-1">
                <label for="subject" class="form-label px-2">موضوع :</label>
                <input type="text" name="subject" class="form-control  fs-12 col-md-9" id="subject"
                       value="{{ $blog->subject }}" required>
            </div>

            <div class=" p-3 mb-1 ">
                <label for="image" class="form-label px-2">تصویر شاخص :</label>
                <input type="file" name="image" class="form-control  fs-12 col-md-9 ">
            </div>
            ...
            <button type="submit" class="btn btn-success w-25 form-control mx-5 mb-3">ویرایش</button>
        </form>
    </div>
@endsection
