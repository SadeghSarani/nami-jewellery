            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5 col-md-7 col-12 mx-auto">
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <form id="login-form" action="{{ route('userSign') }}" method="POST">
                            ...
                            <div class="form-row with-icon form-group">
                                <input type="text" name="name" class="input-ui pr-3"
                            ...
                            <div class="form-row-title">
                                <h3>فامیل خود را وارد کنید</h3>
                            </div>

                            <div class="form-row with-icon form-group">
                                <input type="text" name="family" class="input-ui pr-3"
                            ...
                            <div class="form-row mt-3">
                                <input type="submit" value="ثبت نام" class="btn-primary-cm btn-with-icon mx-auto w-100">
                            </div>
